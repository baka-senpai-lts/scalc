...
But be aware that this WILL **crash** scalc (unless I added stack overflow protection and forgot to edit this line). Anyway, enjoy chaos, it doesn't know what "no" means.
...
You also can write it in postfix notation, like `2 2 +`, however it's currently undefined what will happen if you add third operand like `2 2 2 +`. So do not rely on it too much.
